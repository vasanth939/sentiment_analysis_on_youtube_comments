print("Initializing YouTube Insight AI... This may take a moment.")
...
def analyze():
    ...
    try:
        ...
        if not os.path.exists("data/comments.csv"):
             return jsonify({"error": "Failed to fetch comments or video has no comments."}), 500
        ...
        dates, trend_pos, trend_neg = get_sentiment_trend(results)
...
if __name__ == '__main__':
    ...
    print("----------------------------------------------------------------", flush=True)
    print("YT INSIGHT AI: PRODUCTION SERVER ACTIVE", flush=True)
